...
class Result {
  ...
  Result.fromJson(dynamic json) {
    _zipcode = json['zipcode'] as String;
...
class Structure {
  ...
  Structure.fromJson(dynamic json) {
    _level0 = json['level0'] as String;
    _level1 = json['level1'] as String;
    _level2 = json['level2'] as String;
    _level3 = json['level3'] as String;
    _level4L = json['level4L'] as String;
    _level4LC = json['level4LC'] as String;
    _level4A = json['level4A'] as String;
    _level4AC = json['level4AC'] as String;
    _level5 = json['level5'] as String;
