...
class Address {
  ...
  Address.fromJson(dynamic json) {
    ...
    _road = json['road'] as String;
    _parcel = json['parcel'] as String;
    _bldnm = json['bldnm'] as String;
    _bldnmdc = json['bldnmdc'] as String;
  }
...
class Page {
  ...
  Page.fromJson(dynamic json) {
    ...
    _current = json['current'] as String;
    _size = json['size'] as String;
  }
